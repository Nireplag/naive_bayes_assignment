...
print("Function and class initializer --- %s seconds ---" % (time.time() - st))
...
print("Teste do modelo --- %s seconds ---" % (time.time() - st2))
###############################################################################
...
print("Execução com mensagens --- %s seconds ---" % (time.time() - st3))
print("Tempo total de execução --- %s seconds ---" % (time.time() - st))
